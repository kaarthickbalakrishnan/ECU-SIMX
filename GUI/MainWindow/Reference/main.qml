...
import QtQuick.Layouts 1.3
    ...
    ApplicationWindow {
            ...
            color: "#ffffff"
            title: "ECU SimX"
            Image { width: 494; height: 369; anchors.rightMargin: 0; anchors.bottomMargin: 8; anchors.leftMargin: 8; anchors.topMargin: -6; source: "mainwindow.jpeg"; fillMode: Image.Tile; anchors.fill: parent;  opacity: 0.9
            }
            Text {
                            id: text1
                            x: 216
            ...
            Item {
                ...
                Image { width: 494; height: 369; anchors.rightMargin: 0; anchors.bottomMargin: 8; anchors.leftMargin: 8; anchors.topMargin: -6; source: "bus_config.jpeg"; fillMode: Image.Tile; anchors.fill: parent;  opacity: 0.9
                                }
            ...
            Item {
                ...
                Image { width: 970; height:540; anchors.rightMargin: 0; anchors.bottomMargin: 8; anchors.leftMargin: 8; anchors.topMargin: 45; source: "can_sender.jpeg"; fillMode: Image.Tile; anchors.fill: parent;  opacity: 0.9
                                }
            ...
            Item {
                ...
                width: 940
                height: 412
                Image { width: 940; height: 412; anchors.rightMargin: 0; anchors.bottomMargin: 8; anchors.leftMargin: 8; anchors.topMargin: -6; source: "canviewer.jpeg"; fillMode: Image.Tile; anchors.fill: parent;  opacity: 0.9
                                }
                TextArea {
                        ...
                        if(btn_playPause.checked)
                            {
                                ...
                                testWindow.playViewer();
                            }
                        else
                            {
                                viewPanel.append("Pause Button Pressed")
                                viewPanel.append("Pause Function is not implimented")
                                btn_playPause.text = qsTr("Play")
                                testWindow.pauseViewer();
                            }
                        }
