...
#         self.nextNumber.emit(10)
    ...
    def getCAN_message(self):
        ...
        if periodic_En:
            ...
            msg = can.Message(arbitration_id=0x00,data=[0,0,0,0],is_extended_id=False)
            while (msg.arbitration_id<=0x64):
                try:
                    bus.send_periodic(msg,0.5) #500ms
                    print("message sent on{}".format(bus.channel_info))
                except:
                    print("Message NOT sent")
                msg.arbitration_id=msg.arbitration_id+0x01
                msg.data[0]=random.randint(0,9) #generates random number
...
if __name__ == '__main__':
    ...
    engine.load(QUrl("/home/vish/Downloads/CanSendGUI/main.qml"))
